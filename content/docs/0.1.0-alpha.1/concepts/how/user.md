...
2. Create manifest.yaml file in the repository. See [manifest.yaml](/docs/0.1.0-alpha.1/concepts/how/manifest) doc.
...
- Take a look at how Kubepack handles various scenarios [here](/docs/0.1.0-alpha.1/guides).
