...
2. Create manifest.yaml file in the repository. See [manifest.yaml](/docs/0.1.0-alpha.0/concepts/how/manifest) doc
...
In this example, we're using [this](https://github.com/kubepack/kubepack/tree/master/_testdata/test-9) test-case.
