...
2. Create manifest.yaml file in the repository. See [manifest.yaml](/docs/0.1.0-alpha.2/concepts/how/manifest) doc.
...
- Take a look at how Kubepack handles various scenarios [here](/docs/0.1.0-alpha.2/guides).
